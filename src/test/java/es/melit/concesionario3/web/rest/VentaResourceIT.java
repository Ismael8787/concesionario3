...
import es.melit.concesionario3.IntegrationTest;
...
class VentaResourceIT {
    ...
    public static Venta createEntity(EntityManager em) {
        Venta venta = new Venta().fecha(DEFAULT_FECHA).numFactura(DEFAULT_NUM_FACTURA).precioTotal(DEFAULT_PRECIO_TOTAL);
        return venta;
    }
    ...
    public static Venta createUpdatedEntity(EntityManager em) {
        Venta venta = new Venta().fecha(UPDATED_FECHA).numFactura(UPDATED_NUM_FACTURA).precioTotal(UPDATED_PRECIO_TOTAL);
        return venta;
    }
    ...
    void createVenta() throws Exception {
        ...
        assertThat(testVenta.getNumFactura()).isEqualTo(DEFAULT_NUM_FACTURA);
    ...
    @Test
    @Transactional
    void checkNumFacturaIsRequired() throws Exception {
        int databaseSizeBeforeTest = ventaRepository.findAll().size();
        // set the field null
        venta.setNumFactura(null);
    ...
    void getAllVentas() throws Exception {
        ...
        restVentaMockMvc
            ...
            .andExpect(jsonPath("$.[*].numFactura").value(hasItem(DEFAULT_NUM_FACTURA)))
    ...
    void getVenta() throws Exception {
        ...
        restVentaMockMvc
            ...
            .andExpect(jsonPath("$.numFactura").value(DEFAULT_NUM_FACTURA))
    ...
    void putNewVenta() throws Exception {
        ...
        updatedVenta.fecha(UPDATED_FECHA).numFactura(UPDATED_NUM_FACTURA).precioTotal(UPDATED_PRECIO_TOTAL);
        ...
        assertThat(testVenta.getNumFactura()).isEqualTo(UPDATED_NUM_FACTURA);
    ...
    void partialUpdateVentaWithPatch() throws Exception {
        ...
        partialUpdatedVenta.numFactura(UPDATED_NUM_FACTURA);
    ...
    void fullUpdateVentaWithPatch() throws Exception {
        ...
        partialUpdatedVenta.fecha(UPDATED_FECHA).numFactura(UPDATED_NUM_FACTURA).precioTotal(UPDATED_PRECIO_TOTAL);
