...
class CocheResourceIT {
    ...
    public static Coche createEntity(EntityManager em) {
        Coche coche = new Coche().marca(DEFAULT_MARCA).modelo(DEFAULT_MODELO).precio(DEFAULT_PRECIO).vendido(DEFAULT_VENDIDO);
        return coche;
    }
    ...
    public static Coche createUpdatedEntity(EntityManager em) {
        Coche coche = new Coche().marca(UPDATED_MARCA).modelo(UPDATED_MODELO).precio(UPDATED_PRECIO).vendido(UPDATED_VENDIDO);
        return coche;
    }
    ...
    void putNewCoche() throws Exception {
        ...
        updatedCoche.marca(UPDATED_MARCA).modelo(UPDATED_MODELO).precio(UPDATED_PRECIO).vendido(UPDATED_VENDIDO);
    ...
    void fullUpdateCocheWithPatch() throws Exception {
        ...
        partialUpdatedCoche.marca(UPDATED_MARCA).modelo(UPDATED_MODELO).precio(UPDATED_PRECIO).vendido(UPDATED_VENDIDO);
